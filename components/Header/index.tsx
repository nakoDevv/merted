...
import LogoMertedImg from "public/images/LogoMerted.png"
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <Image className="h-20 w-auto" src={LogoMertedImg} alt="logo" />
          </a>
        </div>
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          <a href="#" className="text-lg font-semibold leading-6 text-white shadow-lg hover:shadow-red-900">
           About Us
          </a>
          <a href="#" className="text-lg font-semibold leading-6 text-white shadow-lg hover:shadow-red-900">
           Buy
